/**
 * UNIFED - PROBATUM · CASO REAL ANONIMIZADO v13.11.3-PURE
 * ============================================================================
    ...
    function _renderTriangulationMatrix() {
        try {
            ...
            if (!container) {
                ...
                // CORR-v13.11.3: injectar DENTRO do #pureDashboard (não após) para
                // herdar o fundo dark (#0f172a) e evitar "sangramento" de fundo branco.
                if (purePanel) purePanel.appendChild(container);
